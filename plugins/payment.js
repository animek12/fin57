...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah Owner : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `Follow Tiktok My Bestie`, sourceUrl: 'https://www.tiktok.com/@alvin_ch1', thumbnail: await (await fetch('https://telegra.ph/file/1ee2290eedd3330a66df8.jpg')).buffer(),}} 
     }) 
}
